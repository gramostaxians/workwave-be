...
public interface LeaveRequestRepository extends JpaRepository<LeaveRequest, Long> {
    ...
    @Query("SELECT lr FROM LeaveRequest lr WHERE lr.user.id = :userId AND lr.status = 'APPROVED' ORDER BY lr.start_date DESC")
    List<LeaveRequest> getAllApprovedLeaveRequests(@Param("userId") Long userId);
